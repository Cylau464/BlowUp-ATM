...
Shader "Toony Colors Pro 2/Hybrid Shader"
{
	...
	//# Base
		...
		[Toggle(VERTEX_COLOR_ENABLE)] _VertexColorEnable ("Vertex Color Enable", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma multi_compile_local _ VERTEX_COLOR_ENABLE
			//#pragma shader_feature_local VERTEX_COLOR_ENABLE
