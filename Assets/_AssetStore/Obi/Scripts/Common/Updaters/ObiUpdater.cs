...
namespace Obi
{
    ...
    public abstract class ObiUpdater : MonoBehaviour
    {
        ...
        static ProfilerMarker m_UpdateColliderMarker = new ProfilerMarker("Update Colliders");
        static ProfilerMarker m_UpdateRigidBodiesMarker = new ProfilerMarker("Update Rigidbodies");
        static ProfilerMarker m_UpdateWorldMarker = new ProfilerMarker("Update World");

        static ProfilerMarker m_SolverJobsMarker = new ProfilerMarker("Solver Jobs Kick Off");
        static ProfilerMarker m_SolverJobsWaitMarker = new ProfilerMarker("Solver Jobs Wait");
        static ProfilerMarker m_SolverJobsReleaseMarker = new ProfilerMarker("Solver Jobs Release");
        ...
        protected void BeginStep(float stepDeltaTime)
        {
            using (m_BeginStepPerfMarker.Auto())
            {
                ...
                using (m_SolverJobsWaitMarker.Auto())
                {
                ...
                using (m_SolverJobsReleaseMarker.Auto())
                {
                    foreach (ObiSolver solver in solvers)
                    if (solver != null)
